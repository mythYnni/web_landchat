...
const countries = [
    ...
    select_box = document.querySelector('.options-phone'),
    search_box = document.querySelector('.search-box-phone'),
    input_box = document.querySelector('input[type="tel"]'),
    selected_option = document.querySelector('.selected-option-phone div');
